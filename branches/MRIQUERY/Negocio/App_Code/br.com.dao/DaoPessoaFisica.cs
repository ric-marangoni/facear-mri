    ...
    public class DaoPessoaFisica:Dao<PessoaFisica>
    {
        ...
        public void salvar(PessoaFisica obj)
        {
            try
            {
                ...
                string sql =
                "INSERT INTO TB_USUARIO(NOME,SEXO,DATA_NASCIMENTO,CPF_CNPJ,SENHA,LOGIN,STATUS,EMAIL_PESSOAL,EMAIL_COMERCIAL,TELEFONE_COMERCIAL,TELEFONE_CELULAR,TELEFONE_RESIDENCIAL,DATA_CADASTRO,ENDERECO)" +
        ...
        public Cliente pegaClientePeloLogin(String login, String senha)
        {
            ...
            try
            {
                ...
                string sql = "SELECT U.ID_USUARIO, U.NOME, U.SEXO, U.DATA_NASCIMENTO, U.CPF_CNPJ, U.SENHA, U.LOGIN, U.STATUS," +
                             ...
                             "FROM TB_USUARIO U " +
                             "INNER JOIN TB_ENDERECO END ON U.ENDERECO = END.ID_ENDERECO " +
